...
class SystemMessagesTableSeeder extends Seeder {
    ...
    public function run(){
        ...
        DicVal::create(array('dic_id'=>$dic_id,'slug'=>'moderator.order.closed','name'=> 'Заказ <a href="[link]">№[order]</a> закрыт (<a href="[organization_link]">[organization]</a>)','order'=>24));
        ...
        DicVal::create(array('dic_id'=>$dic_id,'slug'=>'moderator.update-profile-individual','name'=> 'Индивидуальный слушатель <a href="[link]">[listener]</a> обновил(-а) регистрационные данные.','order'=>35));
