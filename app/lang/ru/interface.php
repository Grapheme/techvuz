...
return array(
    ...
    'ACCOUNT_STATUS' => array(
        ...
        'not_moderator_approve' => '«Ваш личный кабинет активирован. Происходит проверка администратором сайта»',
    ...
    'ACCOUNT_EMAIL_STATUS' => array(
        ...
        'not_active' => '«Для активации Вашего личного кабинета и получения доступа к документации (договоры, счета, акты) Вам необходимо подтвердить e-mail, указанный при регистрации.',
