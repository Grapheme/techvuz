...
return array(
    ...
    'ACCOUNT_STATUS' => array(
        ...
        'blocked_edit_profile' => 'Изменения профиля заблокировано до закрытия всех заказов. Если обнаружили ошибку в регистрационных данных, обратитесь к администрации сайта',
        'blocked_edit_listener_profile' => 'Изменения регистрационных данных заблокировано до закрытия всех заказов. Для внесения изменений обратитесь к администрации сайта'
    ),
