...
//            return Redirect::route('individual-orders');
    ...
    private function getDocumentVariables($extract = FALSE){
        ...
        $variables = array(
            ...
            'DataOplatuZakaza' => $dateTime->setDateString($order->payment_date)->timezone('Europe/Moscow')->format('d.m.y'),
            'DataOformleniyaZakaza' => $order->created_at->format('d.m.y'),
            'DataOformleniyaZakazaSlovami' => $dateTime->setDateString($order->created_at)->timezone('Europe/Moscow')->months(),
            'DataZakrutiyaZakaza' => $dateTime->setDateString($order->close_date)->timezone('Europe/Moscow')->format('d.m.y'),
            'DataZakrutiyaZakazaSlovami' => $dateTime->setDateString($order->close_date)->timezone('Europe/Moscow')->months(),
