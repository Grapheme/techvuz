            ...
            @foreach($spisok as $listener_id => $listener)
                <tr>
                    ...
                    @if(count($listener['course']))
                        ...
                        <p style="text-align: center; font-size: 16px;">Срок освоения ДПП –<br>{{ $listener['course'][0]['hours'] }} {{ Lang::choice('час|часа|часов', (int)$listener['course'][0]['hours']) }}</p>
            ...
            @foreach($listener['course'] as $course_index => $course)
                ...
                <tr>
                    ...
                    <td style="border-width: 1px;border-color: #000;border-style: solid; padding: 5px;">
                        ...
                        <p style="text-align: center; font-size: 16px;">Срок освоения ДПП –<br>{{ $course['hours'] }} {{ Lang::choice('час|часа|часов', (int)$course['hours']) }}</p>
