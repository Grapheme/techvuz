        ...
        <table cellspacing="0" cellpadding="0" border="1">
            <tbody>
                <tr>
                    ...
                    <td valign="top" style="padding: 3pt 6pt 3pt 6pt;"><p align="center"><strong>Цена (руб)</strong></p></td>
                    <td valign="top" style="padding: 3pt 6pt 3pt 6pt;"><p align="center"><strong>Скидка</strong></p></td>
                    <td valign="top" style="padding: 3pt 6pt 3pt 6pt;"><p align="center"><strong>Сумма (руб)</strong></p></td>
                </tr>
                <?php $index = 1;?>
            @foreach($spisok as $course_id => $course)
                <tr>
                    <td valign="top" style="padding: 3pt 6pt 3pt 6pt;"><p align="center">{{ $index }}</p></td>
                    ...
                    <td valign="top" style="padding: 3pt 6pt 3pt 6pt;"><p align="center">{{ number_format($course['price'],2,',',' ') }}</p></td>
                    <td valign="top" style="padding: 3pt 6pt 3pt 6pt;"><p align="center">{{ number_format($course['discount'],2,',',' ') }}</p></td>
                    <td valign="top" style="padding: 3pt 6pt 3pt 6pt;"><p align="center">{{ number_format($course['summa'],2,',',' ') }}</p></td>
                </tr>
                <?php $index++; ?>
            @endforeach
            </tbody>
