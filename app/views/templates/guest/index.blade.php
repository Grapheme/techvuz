            ...
            <div class="count-add">
                <div class="container-fluid">
                    <div class="row no-gutter margin-top-20">
                        <div style="float: right; margin-right: -15px;" class="col-xs-offset-6 col-sm-offset-6 col-md-offset-6 col-lg-offset-6 col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <div style="float: left; margin-left: -15px; margin-top: -17px;" class="col-xs-offset-6 col-sm-offset-6 col-md-offset-6 col-lg-offset-6 col-xs-6 col-sm-6 col-md-6 col-lg-6">
