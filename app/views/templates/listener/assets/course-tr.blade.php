<tr>
    ...
    <td class="td-status-bar">
        <div title="{{ Lang::get('interace.STUDY_PROGRESS'.getCourseStudyProgress($listener_course)) }}" class="ui-progress-bar bar-1 completed-{{ getCourseStudyProgress($listener_course) }} clearfix">
